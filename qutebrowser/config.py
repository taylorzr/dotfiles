...
config.bind('gc', 'buffer calendar')
config.bind('ge', 'buffer mail.google.com')
config.bind('gh', 'buffer hipchat')
config.bind('gi', 'buffer inbox.google.com')
config.bind('gl', 'buffer localhost')
config.bind('gp', 'buffer pivotal')
config.bind('gs', 'buffer slack')
config.bind('gw', 'buffer whatsapp')
config.bind('gy', 'buffer youtube')
